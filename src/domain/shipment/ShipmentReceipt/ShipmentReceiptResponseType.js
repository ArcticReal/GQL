...
const ShipmentReceiptResponseType = new GraphQLObjectType({
  name: 'ShipmentReceiptResponseType',
  description: 'response type for ShipmentReceipt',
...
export {ShipmentReceiptResponseType};
