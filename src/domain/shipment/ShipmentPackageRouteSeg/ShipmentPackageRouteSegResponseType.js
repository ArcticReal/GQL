...
const ShipmentPackageRouteSegResponseType = new GraphQLObjectType({
  name: 'ShipmentPackageRouteSegResponseType',
  description: 'response type for ShipmentPackageRouteSeg',
...
export {ShipmentPackageRouteSegResponseType};
