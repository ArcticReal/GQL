...
const createProductMeterType = {
  ...
  args:{productMeterTypeToBeAdded: {type: ProductMeterTypeInputType}},
  resolve: (root, args, {req}) => {
    return postToUrl(`product/product/productMeterTypes/add?`, args.productMeterTypeToBeAdded, req);
  }
};
