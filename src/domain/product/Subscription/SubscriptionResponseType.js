...
const SubscriptionResponseType = new GraphQLObjectType({
  name: 'SubscriptionResponseType',
  description: 'response type for Subscription',
...
export {SubscriptionResponseType};
