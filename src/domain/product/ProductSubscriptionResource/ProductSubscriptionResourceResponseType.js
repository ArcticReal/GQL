...
const ProductSubscriptionResourceResponseType = new GraphQLObjectType({
  name: 'ProductSubscriptionResourceResponseType',
  description: 'response type for ProductSubscriptionResource',
...
export {ProductSubscriptionResourceResponseType};
