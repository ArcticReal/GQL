...
const ProductPriceResponseType = new GraphQLObjectType({
  name: 'ProductPriceResponseType',
  description: 'response type for ProductPrice',
...
export {ProductPriceResponseType};
