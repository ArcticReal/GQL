...
const ProductStoreResponseType = new GraphQLObjectType({
  name: 'ProductStoreResponseType',
  description: 'response type for ProductStore',
...
export {ProductStoreResponseType};
