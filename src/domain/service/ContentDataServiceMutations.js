...
const getElectronicText = {
  ...
  args:{contentId: {type: GraphQLString},content: {type: new GraphQLList(KeyValueType)}},
  resolve: (root, args, {req}) => {
...
const updateFile = {
  ...
  args:{textData: {type: GraphQLString},rootDir: {type: GraphQLString},objectInfo: {type: GraphQLString},dataResourceTypeId: {type: GraphQLString},dataResource: {type: new GraphQLList(KeyValueType)},binData: {type: GraphQLString}},
  resolve: (root, args, {req}) => {
