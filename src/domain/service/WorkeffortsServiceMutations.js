...
const indexWorkEffortKeywords = {
  ...
  args:{workEffortId: {type: GraphQLString},workEffortInstance: {type: new GraphQLList(KeyValueType)}},
  resolve: (root, args, {req}) => {
...
const processWorkEffortEventReminder = {
  ...
  args:{bodyParameters: {type: GraphQLString},reminder: {type: new GraphQLList(KeyValueType)}},
  resolve: (root, args, {req}) => {
