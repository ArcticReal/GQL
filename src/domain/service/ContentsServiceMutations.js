...
const changeLeafToNode = {
  ...
  args:{contentId: {type: GraphQLString},userLogin: {type: new GraphQLList(KeyValueType)}},
...
const checkForWaitingApprovals = {
  ...
  args:{thisUserLogin: {type: new GraphQLList(KeyValueType)}},
  resolve: (root, args, {req}) => {
...
const getApprovalsWithPermissions = {
  ...
  args:{userLogin: {type: new GraphQLList(KeyValueType)},contentRevisionSeqId: {type: GraphQLString},rootContentId: {type: GraphQLString},checkPermission: {type: GraphQLString}},
  resolve: (root, args, {req}) => {
...
const getOwnedOrPublishedBlogEntries = {
  ...
  args:{userLogin: {type: new GraphQLList(KeyValueType)},contentId: {type: GraphQLString}},
  resolve: (root, args, {req}) => {
...
const hasApprovalPermission = {
  ...
  args:{userLogin: {type: new GraphQLList(KeyValueType)},contentApprovalId: {type: GraphQLString}},
  resolve: (root, args, {req}) => {
...
const initContentChildCounts = {
  ...
  args:{content: {type: new GraphQLList(KeyValueType)}},
  resolve: (root, args, {req}) => {
...
const renderContentAsText = {
  ...
  args:{templateContext: {type: GraphQLString},outWriter: {type: GraphQLString},contentId: {type: GraphQLString},mimeTypeId: {type: GraphQLString},subContentDataResourceView: {type: new GraphQLList(KeyValueType)},locale: {type: GraphQLString}},
  resolve: (root, args, {req}) => {
...
const renderDataResourceAsText = {
  ...
  args:{templateContext: {type: GraphQLString},outWriter: {type: GraphQLString},dataResourceId: {type: GraphQLString},mimeTypeId: {type: GraphQLString},subContentDataResourceView: {type: new GraphQLList(KeyValueType)},locale: {type: GraphQLString}},
  resolve: (root, args, {req}) => {
...
const renderSubContentAsText = {
  ...
  args:{templateContext: {type: GraphQLString},outWriter: {type: GraphQLString},fromDate: {type: GraphQLString},contentId: {type: GraphQLString},mapKey: {type: GraphQLString},mimeTypeId: {type: GraphQLString},subContentId: {type: GraphQLString},subContentDataResourceView: {type: new GraphQLList(KeyValueType)},locale: {type: GraphQLString}},
  resolve: (root, args, {req}) => {
