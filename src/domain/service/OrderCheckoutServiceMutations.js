...
const createUpdateCustomerAndShippingAddress = {
  ...
  args:{shipToCity: {type: GraphQLString},emailAddress: {type: GraphQLString},shipToAddress1: {type: GraphQLString},shipToPostalCode: {type: GraphQLString},shoppingCart: {type: GraphQLString},shipToCountryGeoId: {type: GraphQLString},shipToStateProvinceGeoId: {type: GraphQLString},lastName: {type: GraphQLString},setDefaultShipping: {type: GraphQLString},shipToContactMechId: {type: GraphQLString},shipToPhoneContactMechId: {type: GraphQLString},userLogin: {type: new GraphQLList(KeyValueType)},emailContactMechId: {type: GraphQLString},keepAddressBook: {type: GraphQLString},firstName: {type: GraphQLString},shipToContactNumber: {type: GraphQLString},shipToAddress2: {type: GraphQLString},billToContactMechId: {type: GraphQLString},shipToCountryCode: {type: GraphQLString},shipToName: {type: GraphQLString},shipToExtension: {type: GraphQLString},productStoreId: {type: GraphQLString},partyId: {type: GraphQLString},shipToAreaCode: {type: GraphQLString},shipToAttnName: {type: GraphQLString}},
  resolve: (root, args, {req}) => {
