...
const UserDetailsDTOResponseType = new GraphQLObjectType({
  name: 'UserDetailsDTOResponseType',
  description: 'response type for UserDetailsDTO',
...
export {UserDetailsDTOResponseType};
