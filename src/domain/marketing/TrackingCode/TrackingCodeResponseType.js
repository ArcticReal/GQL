...
const TrackingCodeResponseType = new GraphQLObjectType({
  name: 'TrackingCodeResponseType',
  description: 'response type for TrackingCode',
...
export {TrackingCodeResponseType};
