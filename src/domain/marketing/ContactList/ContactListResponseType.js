...
const ContactListResponseType = new GraphQLObjectType({
  name: 'ContactListResponseType',
  description: 'response type for ContactList',
...
export {ContactListResponseType};
