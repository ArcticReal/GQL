...
const DocumentTypeResponseType = new GraphQLObjectType({
  name: 'DocumentTypeResponseType',
  description: 'response type for DocumentType',
...
export {DocumentTypeResponseType};
