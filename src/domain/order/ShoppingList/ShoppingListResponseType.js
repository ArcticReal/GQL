...
const ShoppingListResponseType = new GraphQLObjectType({
  name: 'ShoppingListResponseType',
  description: 'response type for ShoppingList',
...
export {ShoppingListResponseType};
