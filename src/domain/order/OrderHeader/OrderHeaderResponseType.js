...
const OrderHeaderResponseType = new GraphQLObjectType({
  name: 'OrderHeaderResponseType',
  description: 'response type for OrderHeader',
...
export {OrderHeaderResponseType};
