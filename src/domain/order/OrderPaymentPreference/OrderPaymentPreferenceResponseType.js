...
const OrderPaymentPreferenceResponseType = new GraphQLObjectType({
  name: 'OrderPaymentPreferenceResponseType',
  description: 'response type for OrderPaymentPreference',
...
export {OrderPaymentPreferenceResponseType};
