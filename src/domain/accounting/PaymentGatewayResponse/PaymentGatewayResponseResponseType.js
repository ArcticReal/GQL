...
const PaymentGatewayResponseResponseType = new GraphQLObjectType({
  name: 'PaymentGatewayResponseResponseType',
  description: 'response type for PaymentGatewayResponse',
...
export {PaymentGatewayResponseResponseType};
